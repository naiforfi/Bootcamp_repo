...
# Tools
This project will use Jupytur Nootbooks on coda environment. Also it uses Python programming language and some some python libraries, such as numpy , pandas for  mathematical functions, data analysis and manipulation. Also for predictive data analysis it uses scikit-learn library, and for data visualization use matplotlib and seaborn.
